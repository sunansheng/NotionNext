...
const Footer = ({ fullWidth = true }) => {
  ...
  return (
    ...
    >
      <span className='fa fa-copyright leading-6'> {` ${y}`} <span> <a href='https://sunansheng.com' className='underline font-bold text-gray-100'>tangly1024.com</a>. Powered by <a href='https://notion.so' className='underline font-bold text-gray-100'>Notion</a> </span>
      <br />
